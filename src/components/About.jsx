  ...
  return (
    <div>
      ...
      <p className="mx-12 font-sans 2xl:text-xl 2xl:mx-64 text-slate-300">
        ...
        completed several projects utilizing SQL databases and back-end
        programming languages such as Java, Python, and C++. In his free time,
        he enjoys playing video games, reading, learning new things, and doing
        activities outdoors such as camping, hiking and kayaking. He is also a
        big LA Dodgers fan and loves being a father to his 5-year-old son.
      </p>
    </div>
  );
}
